...
if __name__ == '__main__':
    ...
    train_data, labels, sents1, sents2 = utils.create_dataset_SSQA(args.train, word_dict, label_dict)
    valid_data, valils, valse1, valse2 = utils.create_dataset_SSQA(args.validation, word_dict, label_dict)
    
    #print(train_data.sentences1)
    ...
    logger.info(msg.format('Training',
                            train_data.sentences1.shape,
                            train_data.sentences2.shape))
    logger.info(msg.format('Validation',
